...
const ConsoleFrame = ({
  ...
  <div className="bg-[#0c0d18] border border-gray-800/60 rounded-2xl overflow-hidden shadow-2xl flex flex-col h-full w-full">
    ...
    <div className="p-6 sm:p-8 flex-1 bg-linear-to-b from-[#121321] to-[#0c0d18] relative">
      {children}
    </div>
  </div>
);
          ...
          <div className="space-y-5">
            ...
            <div className="p-4 rounded-xl bg-gray-900 border border-indigo-500/20 shadow-inner">
              ...
              <p className="text-sm text-gray-200 leading-relaxed mb-4">
                "Build a responsive pricing card component that seamlessly
                reflows from 3 columns to 1 without media-query duplication."
              </p>
          ...
          <div className="space-y-6">
            <div className="relative">
              <div className="text-xs text-indigo-400 font-mono mb-2">
                Analyzing submission structure
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <p className="text-xs text-gray-300 leading-relaxed">
                Candidate demonstrated excellent component architecture and
                state management skills. Minor improvements suggested for
  ...
  return (
    <div className="min-h-screen bg-white selection:bg-indigo-100 selection:text-indigo-900 text-gray-900 pb-20">
      ...
      <section className="relative pt-24 pb-16 md:pt-32 md:pb-24 overflow-hidden px-4">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-5xl h-125 pointer-events-none opacity-40 blur-[100px] bg-linear-to-br from-indigo-100 via-white to-purple-100 -z-10 rounded-full" />

        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-20">
          <div className="flex-1 text-center md:text-left z-10">
            <motion.p className="font-mono text-sm font-medium tracking-tight text-indigo-600">
              {"The-platform-built-for-recruiters"}
            </motion.p>
            ...
            <motion.h1
              ...
              className="text-4xl md:text-[45px] font-bold text-slate-900 tracking-tight mb-6"
            >
              How{" "}
            ...
            >
              From seamless recruiter onboarding to AI-powered candidate
              evaluation, FrontendIQ simplifies frontend hiring by giving you
              actionable insights, not just raw scores.
            </motion.p>
          ...
          <div className="flex-1 w-full max-w-md md:max-w-none relative z-10">
            ...
            >
              <div className="relative bg-white p-2 rounded-3xl shadow-2xl border border-gray-100 transform rotate-1 hover:rotate-0 transition-transform duration-500">
                <div className="absolute inset-0 rounded-3xl bg-linear-to-br from-indigo-500/5 to-purple-500/5 pointer-events-none" />
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-gray-600">
              A closed-loop platform designed exclusively for professional
              hiring teams to assess candidates efficiently.
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="text-left">
                    <div
                      className={`text-[10px] font-mono mb-0.5 ${isActive ? "text-indigo-500" : "text-gray-400"}`}
                    >
                      STEP {s.eyebrow}
                    </div>
                    <div
          ...
          {/* Step Detail Content */}
          <div className="bg-white rounded-3xl border border-gray-100 shadow-xl shadow-gray-200/50 p-6 md:p-12 overflow-hidden relative min-h-125">
      ...
      <section className="py-24">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-gray-600">
              Clear, streamlined journeys for both the hiring team and the
              candidate.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-3xl border border-gray-100 shadow-lg shadow-gray-100 p-8 md:p-10">
              ...
              <div className="space-y-2 relative before:absolute before:inset-y-0 before:left-4.75 before:w-0.5 before:bg-gray-100">
      ...
      <section className="py-24 px-4 max-w-5xl mx-auto">
        <div className="relative rounded-[2.5rem] overflow-hidden bg-gray-900 px-6 py-20 text-center shadow-2xl">
          <div className="absolute inset-0 bg-linear-to-br from-indigo-600 to-purple-800 opacity-90" />
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            ...
            <p className="text-indigo-100 text-lg mb-10">
              Join leading tech teams using FrontendIQ to uncover true developer
              potential with AI-driven, objective evaluations.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/become-recruiter" className="w-full sm:w-auto">
                <Button
                  size="lg"
                  className="w-full sm:w-auto bg-white text-indigo-700 hover:bg-gray-50 hover:scale-105 border-transparent shadow-xl"
                >
                  Become a Recruiter
                </Button>
              </Link>
